...
country1 = Country("Brazil",True)
country_repository.save(country1)

country2 = Country("Peru",True)
country_repository.save(country2)

country3 = Country("Poland",False)
...
city1 = City("Buenos Aires",country1,False)
city_repository.save(city1)

city2 = City("Lima",country2,True)
city_repository.save(city2)

city3 = City("Warsaw",country3,True)
city_repository.save(city3)

city4 = City("Oslo",country4,True)
city_repository.save(city4)

city5 = City("Mexico City",country5,False)
city_repository.save(city5)

city6 = City("Moscow",country6,True)
